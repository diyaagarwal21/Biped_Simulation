...
frequency = 0.5
amplitude = 0.07 #330836351 #(0.5 - 0.34 / 2)
...
with mujoco.viewer.launch_passive(m, d) as viewer:
  ...
  while viewer.is_running():
    ...
    hip_y = (amplitude * math.sin(2 * np.pi * frequency * step_start)) + 0.424 
    ...
    # d.ctrl[2] = -(Kp * (hip_angle - d.qpos[3])) + (Kd * (-d.qvel[3])) # Hip joint 2
    # d.ctrl[3] = ((Kp * (knee_angle - d.qpos[4])) + (Kd * (-d.qvel[4]))) # Knee joint 2
